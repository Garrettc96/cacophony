...
public class Channel extends TableImpl<ChannelRecord> {
     ...
     */
    public final TableField<ChannelRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>cacophony.channel.name</code>.
     */
    public final TableField<ChannelRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>cacophony.channel.description</code>.
     */
    public final TableField<ChannelRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>cacophony.channel.visibility</code>.
     */
    public final TableField<ChannelRecord, String> VISIBILITY = createField(DSL.name("visibility"), SQLDataType.VARCHAR(50).nullable(false), this, "");
     ...
     */
    public final TableField<ChannelRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
     ...
     * <code>cacophony.channel_visibility</code> table.
     */
