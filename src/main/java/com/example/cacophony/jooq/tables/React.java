...
public class React extends TableImpl<ReactRecord> {
     ...
     */
    public final TableField<ReactRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>cacophony.react.user_id</code>.
     */
    public final TableField<ReactRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>cacophony.react.name</code>.
     */
    public final TableField<ReactRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>cacophony.react.s3_path</code>.
     */
    public final TableField<ReactRecord, String> S3_PATH = createField(DSL.name("s3_path"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>cacophony.react.created_at</code>.
     */
    public final TableField<ReactRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>cacophony.react.updated_at</code>.
     */
    public final TableField<ReactRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public <O extends Record> React(Table<O> path, ForeignKey<O, ReactRecord> childPath, InverseForeignKey<O, ReactRecord> parentPath) {
    ...
    public static class ReactPath extends React implements Path<ReactRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> ReactPath(Table<O> path, ForeignKey<O, ReactRecord> childPath, InverseForeignKey<O, ReactRecord> parentPath) {
    ...
    public MessageReactPath messageReact() {
        if (_messageReact == null)
            _messageReact = new MessageReactPath(this, null, Keys.MESSAGE_REACT__MESSAGE_REACT_REACT_ID_FKEY.getInverseKey());
