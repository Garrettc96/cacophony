...
public class UserRole extends TableImpl<UserRoleRecord> {
    ...
    /**
     * The reference instance of <code>cacophony.user_role</code>
     */
    ...
    /**
     * The column <code>cacophony.user_role.role</code>.
     */
    public final TableField<UserRoleRecord, String> ROLE = createField(DSL.name("role"),
    ...
    /**
     * Create an aliased <code>cacophony.user_role</code> table reference
     */
    ...
    /**
     * Create a <code>cacophony.user_role</code> table reference
     */
    public UserRole() {
        this(DSL.name("user_role"), null);
    }

    public <O extends Record> UserRole(Table<O> path, ForeignKey<O, UserRoleRecord> childPath,
            InverseForeignKey<O, UserRoleRecord> parentPath) {
    ...
    public static class UserRolePath extends UserRole implements Path<UserRoleRecord> {
        ...
        public <O extends Record> UserRolePath(Table<O> path, ForeignKey<O, UserRoleRecord> childPath,
                InverseForeignKey<O, UserRoleRecord> parentPath) {
    ...
    /**
     * Get the implicit to-many join path to the <code>cacophony.c_user</code> table
     */
    public CUserPath cUser() {
        if (_cUser == null)
            _cUser = new CUserPath(this, null, Keys.C_USER__FK_C_USER_USER_ROLE.getInverseKey());
