...
public class ConversationType extends TableImpl<ConversationTypeRecord> {
     ...
     */
    public final TableField<ConversationTypeRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    private ConversationType(Name alias, Table<ConversationTypeRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private ConversationType(Name alias, Table<ConversationTypeRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table(), where);
    }

    /**
     * Create an aliased <code>cacophony.conversation_type</code> table
     * reference
     */
    ...
    public <O extends Record> ConversationType(Table<O> path, ForeignKey<O, ConversationTypeRecord> childPath, InverseForeignKey<O, ConversationTypeRecord> parentPath) {
    ...
    public static class ConversationTypePath extends ConversationType implements Path<ConversationTypeRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> ConversationTypePath(Table<O> path, ForeignKey<O, ConversationTypeRecord> childPath, InverseForeignKey<O, ConversationTypeRecord> parentPath) {
     ...
     * <code>cacophony.conversation</code> table
     */
