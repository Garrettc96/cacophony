...
public class UserConversation extends TableImpl<UserConversationRecord> {
     ...
     */
    public final TableField<UserConversationRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>cacophony.user_conversation.channel_id</code>.
     */
    public final TableField<UserConversationRecord, UUID> CHANNEL_ID = createField(DSL.name("channel_id"), SQLDataType.UUID.nullable(false), this, "");

    private UserConversation(Name alias, Table<UserConversationRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private UserConversation(Name alias, Table<UserConversationRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table(), where);
    }

    /**
     * Create an aliased <code>cacophony.user_conversation</code> table
     * reference
     */
    ...
    public <O extends Record> UserConversation(Table<O> path, ForeignKey<O, UserConversationRecord> childPath, InverseForeignKey<O, UserConversationRecord> parentPath) {
    ...
    public static class UserConversationPath extends UserConversation implements Path<UserConversationRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> UserConversationPath(Table<O> path, ForeignKey<O, UserConversationRecord> childPath, InverseForeignKey<O, UserConversationRecord> parentPath) {
    ...
    public List<ForeignKey<UserConversationRecord, ?>> getReferences() {
        return Arrays.asList(Keys.USER_CONVERSATION__FK_USER_CONVERSATION_C_USER, Keys.USER_CONVERSATION__FK_USER_CONVERSATION_CONVERSATION);
    }
