...
public class Message extends TableImpl<MessageRecord> {
     ...
     */
    public final TableField<MessageRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>cacophony.message.conversation_id</code>.
     */
    public final TableField<MessageRecord, UUID> CONVERSATION_ID = createField(DSL.name("conversation_id"), SQLDataType.UUID.nullable(false), this, "");
     ...
     */
    public final TableField<MessageRecord, String> S3_PATH = createField(DSL.name("s3_path"), SQLDataType.VARCHAR(255), this, "");
     ...
     */
    @Deprecated
    public final TableField<MessageRecord, Object> FTS_VECTOR = createField(DSL.name("fts_vector"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tsvector\""), this, "");
     ...
     */
    public final TableField<MessageRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_MESSAGE_CONVERSATION_ID, Indexes.IDX_MESSAGE_FTS_VECTOR, Indexes.IDX_MESSAGE_USER_ID);
    }
    ...
    public MessageReactPath messageReact() {
        if (_messageReact == null)
            _messageReact = new MessageReactPath(this, null, Keys.MESSAGE_REACT__MESSAGE_REACT_MESSAGE_ID_FKEY.getInverseKey());
